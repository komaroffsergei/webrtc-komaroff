...
ROUTING_SYSTEM_PROMPT = (
    ...
    "3) Сценарий nearest_airports выбирай, если пользователь:\n"
    "   - просит ближайший/самый близкий аэропорт\n"
    "   - просит самый дальний/самый удалённый аэропорт\n"
    "   - просит построить маршрут до ближайшего/самого дальнего аэропорта\n"
    "4) Короткие ответы пользователя НЕ считать новым запросом, если они логически подходят как продолжение предыдущего сценария.\n"
    "5) НЕ выбирай аэропортные сценарии (airports_*) если пользователь не упоминает аэропорты явно.\n"
    "   Исключение: nearest_airports допустим для запросов про ближайший/самый дальний аэропорт.\n"
    "6) НЕ выбирай airports_clarify для запросов про ближайший/самый дальний аэропорт.\n"
    "7) Если запрос не подходит ни под один специализированный сценарий — НЕ вызывай инструменты.\n"
